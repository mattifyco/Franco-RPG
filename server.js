...
app.post('/api/auth/login', async (req, res) => {
  ...
  // Configuração de cookie simplificada para máxima compatibilidade
  res.cookie('user', JSON.stringify(userResponse), { 
    maxAge: 7 * 24 * 60 * 60 * 1000, 
    path: '/',
    httpOnly: false, // Permite que o JS do frontend leia o cookie
    secure: false    // Permite em conexões HTTP e HTTPS sem frescura
  });
