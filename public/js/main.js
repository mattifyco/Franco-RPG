  ...
  loginForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (response.ok && data.user) {
        // CORRIGIDO: O servidor retorna { id, role, name, email } diretamente em data.user
        // Não usar user_metadata (formato Supabase Auth) pois o backend usa tabela própria
        currentUser = {
          id: data.user.id,
